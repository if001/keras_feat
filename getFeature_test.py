...
def get_hidden(mynet,X_train):
    ...
    i = 0
    for value in worddic.keys() :
        print(i*160,i*160+160)
        worddic[value] = encoded_imgs[i*160:i*160+160].mean(axis=0)
        i += 1
...
def main():
    ...
    get_hidden(mynet,mydata.X_train)
